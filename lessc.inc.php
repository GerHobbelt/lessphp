...
class lessc {
	...
	protected function compileProp($prop, $block, $out) {
		...
		case "import";
			...
			// TODO: and temporarily swap the importDir+baseDir section for the child's,
...
class lessc_parser {
	...
	protected function parseChunk() {
		...
		if ($this->import($importValue)) {
			$this->append($importValue, $s);                	// TODO: fix the code below this...
			return true;                                    	// TODO: fix the code below this...
